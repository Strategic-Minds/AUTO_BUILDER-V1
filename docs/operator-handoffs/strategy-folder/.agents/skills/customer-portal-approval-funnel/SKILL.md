---
name: customer-portal-approval-funnel
description: Use when designing the Strategic Minds customer website funnel, deposit path, dashboard, approval-gated timeline, one-free-revision policy, final handoff, and support path.
---

# customer-portal-approval-funnel

## Mission
Use when designing the Strategic Minds customer website funnel, deposit path, dashboard, approval-gated timeline, one-free-revision policy, final handoff, and support path.
