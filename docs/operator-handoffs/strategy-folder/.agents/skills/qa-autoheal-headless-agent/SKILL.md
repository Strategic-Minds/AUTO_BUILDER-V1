---
name: qa-autoheal-headless-agent
description: Use when executing 5-stage QA, Playwright Chromium desktop/mobile/PWA tests, humanistic headless user simulation, score matrix, and auto-heal preview branch repair loop.
---

# qa-autoheal-headless-agent

## Mission
Use when executing 5-stage QA, Playwright Chromium desktop/mobile/PWA tests, humanistic headless user simulation, score matrix, and auto-heal preview branch repair loop.
