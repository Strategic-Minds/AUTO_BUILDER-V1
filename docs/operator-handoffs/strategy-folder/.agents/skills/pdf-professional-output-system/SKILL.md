---
name: pdf-professional-output-system
description: Use when formatting docs into professional consultation-pack PDF-ready layouts with cover, table of contents, executive summary, visual sections, and export instructions.
---

# pdf-professional-output-system

## Mission
Use when formatting docs into professional consultation-pack PDF-ready layouts with cover, table of contents, executive summary, visual sections, and export instructions.
