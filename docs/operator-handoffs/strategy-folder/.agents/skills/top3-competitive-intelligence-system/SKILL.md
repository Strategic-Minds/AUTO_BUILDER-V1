---
name: top3-competitive-intelligence-system
description: Use when researching top 3 public benchmark sites/systems, selecting competitors by evidence, extracting public patterns, and producing original reconstruction strategy without copying protected assets.
---

# top3-competitive-intelligence-system

## Mission
Use when researching top 3 public benchmark sites/systems, selecting competitors by evidence, extracting public patterns, and producing original reconstruction strategy without copying protected assets.
