---
name: omnichannel-comms-whatsapp-slack-buffer
description: Use when drafting and gating WhatsApp, Gmail, Slack, Buffer/social, and customer notifications with consent ledger, approval requirements, and dry-run receipts.
---

# omnichannel-comms-whatsapp-slack-buffer

## Mission
Use when drafting and gating WhatsApp, Gmail, Slack, Buffer/social, and customer notifications with consent ledger, approval requirements, and dry-run receipts.
