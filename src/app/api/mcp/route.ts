...
const handler = createMcpHandler(
  (server) => {
    ...
    server.registerTool("run_platform_provisioning_job", { title: "Run Platform Provisioning Job", description: "Plan approval-gated GitHub, Vercel, AI Gateway, sandbox, workflow, and agent provisioning.", inputSchema: platformProvisioningSchema }, async (payload) => mcpText(runPlatformProvisioningJob(payload as never)));
