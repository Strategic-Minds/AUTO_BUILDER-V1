...
export function expandedStep35Rows(): Step35Row[] {
  return step35Rows.flatMap(([local_path, drive_parent_folder_title, drive_parent_folder_id, recommended_drive_subfolder, status_after_upload]) => {
