...
export const providerRegistry: AutoBuilderProvider[] = [
  ...
  provider({ providerId: "n8n", displayName: "n8n MCP", category: "cloud", authType: "access_token", requiredSecrets: ["N8N_MCP_ACCESS_TOKEN", "N8N_MCP_SERVER_URL"], optionalSecrets: ["N8N_WEBHOOK_URL", "N8N_BASE_URL"], envBindings: ["N8N_MCP_ACCESS_TOKEN", "N8N_MCP_SERVER_URL", "N8N_WEBHOOK_URL", "N8N_BASE_URL"], apiSupportLevel: "partial", readiness: "planned", executeActions: ["execute_n8n_mcp_tool", "trigger_n8n_webhook", "replay_n8n_execution"], readActions: ["read_n8n_workflows", "read_n8n_executions", "read_n8n_mcp_status"], validationActions: ["validate_n8n_connection"], syncActions: ["sync_n8n_receipts"], fallbackMode: "Use N8N_MCP_ACCESS_TOKEN and N8N_MCP_SERVER_URL from Vercel env. Do not store access token in repo." }),
