---
name: prompt-contract-registry
description: Maintain prompt contracts, system instructions, input-output schemas, tool permissions, memory scopes, and skill trigger boundaries. Use when AUTO_BUILDER needs enterprise-grade agent automation, orchestration, scaffolding, workflow control, validation, memory, communication, intelligence, or release governance for websites, lead gen, auto social, business systems, XPS locations, PUC attendee systems, or Strategic Minds licensing.
---

# Prompt Contract Registry

## Purpose
Maintain prompt contracts, system instructions, input-output schemas, tool permissions, memory scopes, and skill trigger boundaries.
