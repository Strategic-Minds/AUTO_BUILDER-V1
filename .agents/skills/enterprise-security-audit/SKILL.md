...
description: Audit OAuth scopes, RLS, service roles, MCP permissions, webhooks, PII handling, tenant isolation, prompt injection defenses, and destructive action gates. Use when AUTO_BUILDER needs enterprise-grade autonomous swarm operations, safety gates, receipts, and scalable multi-tenant business-system execution.
---

# Enterprise Security Audit

## Mission
Audit OAuth scopes, RLS, service roles, MCP permissions, webhooks, PII handling, tenant isolation, prompt injection defenses, and destructive action gates.
