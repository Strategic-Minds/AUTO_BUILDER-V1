...
description: Operate incident response, SRE runbooks, cron failure handling, webhook retries, provider outage triage, queue deadlock recovery, escalation paths, and operational receipts for AUTO_BUILDER. Use when AUTO_BUILDER needs enterprise-grade autonomous swarm operations, safety gates, receipts, and scalable multi-tenant business-system execution.
---

# Incident Response Sre

## Mission
Operate incident response, SRE runbooks, cron failure handling, webhook retries, provider outage triage, queue deadlock recovery, escalation paths, and operational receipts for AUTO_BUILDER.
