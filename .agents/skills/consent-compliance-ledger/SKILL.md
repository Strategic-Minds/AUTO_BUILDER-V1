---
name: consent-compliance-ledger
description: Track consent, opt-in, opt-out, unsubscribe, communication proof, jurisdiction, consent source, and compliance gates before any outbound WhatsApp, SMS, email, or social DM action. Use when AUTO_BUILDER needs enterprise-grade autonomous swarm operations, safety gates, receipts, and scalable multi-tenant business-system execution.
---

# Consent Compliance Ledger

## Mission
Track consent, opt-in, opt-out, unsubscribe, communication proof, jurisdiction, consent source, and compliance gates before any outbound WhatsApp, SMS, email, or social DM action.
