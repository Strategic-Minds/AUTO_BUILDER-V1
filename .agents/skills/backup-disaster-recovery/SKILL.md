...
description: Plan and validate backups, exports, restore drills, disaster recovery, provider outage continuity, Vercel rollback, Supabase backup, Drive backup, and recovery receipts. Use when AUTO_BUILDER needs enterprise-grade autonomous swarm operations, safety gates, receipts, and scalable multi-tenant business-system execution.
---

# Backup Disaster Recovery

## Mission
Plan and validate backups, exports, restore drills, disaster recovery, provider outage continuity, Vercel rollback, Supabase backup, Drive backup, and recovery receipts.
