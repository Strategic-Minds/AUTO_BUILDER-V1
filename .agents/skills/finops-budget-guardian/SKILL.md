---
name: finops-budget-guardian
description: Control spend budgets, AI Gateway usage, browser automation costs, provider billing risk, tenant usage limits, alerts, hard stops, and cost receipts for autonomous operations. Use when AUTO_BUILDER needs enterprise-grade autonomous swarm operations, safety gates, receipts, and scalable multi-tenant business-system execution.
---

# Finops Budget Guardian

## Mission
Control spend budgets, AI Gateway usage, browser automation costs, provider billing risk, tenant usage limits, alerts, hard stops, and cost receipts for autonomous operations.
