---
name: template-registry-renderer
description: Maintain reusable templates for websites, Drive folders, Supabase schemas, agent specs, content packs, social calendars, and client delivery systems. Use when AUTO_BUILDER needs enterprise-grade agent automation, orchestration, scaffolding, workflow control, validation, memory, communication, intelligence, or release governance for websites, lead gen, auto social, business systems, XPS locations, PUC attendee systems, or Strategic Minds licensing.
---

# Template Registry Renderer

## Purpose
Maintain reusable templates for websites, Drive folders, Supabase schemas, agent specs, content packs, social calendars, and client delivery systems.
