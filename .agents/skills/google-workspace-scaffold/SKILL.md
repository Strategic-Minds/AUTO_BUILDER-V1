---
name: google-workspace-scaffold
description: Design and validate Google Workspace accounts, groups, shared drives, folder trees, aliases, routing, permissions, and source-truth conventions for AUTO_BUILDER systems. Use when AUTO_BUILDER needs enterprise-grade agent automation, orchestration, scaffolding, workflow control, validation, memory, communication, intelligence, or release governance for websites, lead gen, auto social, business systems, XPS locations, PUC attendee systems, or Strategic Minds licensing.
---

# Google Workspace Scaffold

## Purpose
Design and validate Google Workspace accounts, groups, shared drives, folder trees, aliases, routing, permissions, and source-truth conventions for AUTO_BUILDER systems.
