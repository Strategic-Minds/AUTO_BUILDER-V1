---
name: customer-success-supportdesk
description: Operate client onboarding, support queues, customer success tasks, human escalations, SLA tiers, support receipts, renewal risks, and upgrade paths. Use when AUTO_BUILDER needs enterprise-grade autonomous swarm operations, safety gates, receipts, and scalable multi-tenant business-system execution.
---

# Customer Success Supportdesk

## Mission
Operate client onboarding, support queues, customer success tasks, human escalations, SLA tiers, support receipts, renewal risks, and upgrade paths.
