---
name: product-package-catalog
description: Define sellable AUTO_BUILDER packages, license tiers, XPS location products, PUC attendee systems, Strategic Minds consulting offers, and entitlement matrices. Use when AUTO_BUILDER needs enterprise-grade agent automation, orchestration, scaffolding, workflow control, validation, memory, communication, intelligence, or release governance for websites, lead gen, auto social, business systems, XPS locations, PUC attendee systems, or Strategic Minds licensing.
---

# Product Package Catalog

## Purpose
Define sellable AUTO_BUILDER packages, license tiers, XPS location products, PUC attendee systems, Strategic Minds consulting offers, and entitlement matrices.
