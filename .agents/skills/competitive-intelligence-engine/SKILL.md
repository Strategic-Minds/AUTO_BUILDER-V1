...
description: Plan, discover, ingest, analyze, document, benchmark, reverse engineer, and reconstruct competitor intelligence under legal and governance constraints. Use when AUTO_BUILDER needs enterprise-grade agent automation, orchestration, scaffolding, workflow control, validation, memory, communication, intelligence, or release governance for websites, lead gen, auto social, business systems, XPS locations, PUC attendee systems, or Strategic Minds licensing.
---

# Competitive Intelligence Engine

## Purpose
Plan, discover, ingest, analyze, document, benchmark, reverse engineer, and reconstruct competitor intelligence under legal and governance constraints.
