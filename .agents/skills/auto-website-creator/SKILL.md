---
name: auto-website-creator
description: Coordinate approved website creation from discovery, brand, template selection, content packs, Next.js scaffold, Supabase wiring, validation, and rollout gates. Use when AUTO_BUILDER needs enterprise-grade agent automation, orchestration, scaffolding, workflow control, validation, memory, communication, intelligence, or release governance for websites, lead gen, auto social, business systems, XPS locations, PUC attendee systems, or Strategic Minds licensing.
---

# Auto Website Creator

## Purpose
Coordinate approved website creation from discovery, brand, template selection, content packs, Next.js scaffold, Supabase wiring, validation, and rollout gates.
