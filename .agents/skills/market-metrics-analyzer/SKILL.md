---
name: market-metrics-analyzer
description: Analyze SEO, traffic, lead-gen, ads, social, conversion, competitor, and business metrics for decision support and performance receipts. Use when AUTO_BUILDER needs enterprise-grade agent automation, orchestration, scaffolding, workflow control, validation, memory, communication, intelligence, or release governance for websites, lead gen, auto social, business systems, XPS locations, PUC attendee systems, or Strategic Minds licensing.
---

# Market Metrics Analyzer

## Purpose
Analyze SEO, traffic, lead-gen, ads, social, conversion, competitor, and business metrics for decision support and performance receipts.
