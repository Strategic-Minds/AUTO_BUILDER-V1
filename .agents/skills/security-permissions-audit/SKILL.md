---
name: security-permissions-audit
description: Audit production risks, permissions, secrets, RLS, workspace roles, MCP scopes, social publishing, payments, customer messaging, and destructive actions. Use when AUTO_BUILDER needs enterprise-grade agent automation, orchestration, scaffolding, workflow control, validation, memory, communication, intelligence, or release governance for websites, lead gen, auto social, business systems, XPS locations, PUC attendee systems, or Strategic Minds licensing.
---

# Security Permissions Audit

## Purpose
Audit production risks, permissions, secrets, RLS, workspace roles, MCP scopes, social publishing, payments, customer messaging, and destructive actions.
