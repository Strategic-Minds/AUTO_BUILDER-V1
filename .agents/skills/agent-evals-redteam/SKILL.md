---
name: agent-evals-redteam
description: Create and run agent evals, prompt-contract tests, red-team checks, governance tests, tenant boundary tests, messaging safety tests, and regression receipts for swarm agents. Use when AUTO_BUILDER needs enterprise-grade autonomous swarm operations, safety gates, receipts, and scalable multi-tenant business-system execution.
---

# Agent Evals Redteam

## Mission
Create and run agent evals, prompt-contract tests, red-team checks, governance tests, tenant boundary tests, messaging safety tests, and regression receipts for swarm agents.
