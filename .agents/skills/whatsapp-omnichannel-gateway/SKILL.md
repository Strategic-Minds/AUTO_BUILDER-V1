---
name: whatsapp-omnichannel-gateway
description: Govern WhatsApp Business Platform, Twilio WhatsApp, inbound webhooks, approved templates, outbound message gates, consent checks, human escalation, and communication receipts for AUTO_BUILDER omnichannel systems. Use when AUTO_BUILDER needs enterprise-grade autonomous swarm operations, safety gates, receipts, and scalable multi-tenant business-system execution.
---

# Whatsapp Omnichannel Gateway

## Mission
Govern WhatsApp Business Platform, Twilio WhatsApp, inbound webhooks, approved templates, outbound message gates, consent checks, human escalation, and communication receipts for AUTO_BUILDER omnichannel systems.
