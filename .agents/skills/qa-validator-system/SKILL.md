---
name: qa-validator-system
description: Run enterprise QA validation across source truth, manifests, skills, scaffolds, APIs, routes, Supabase, Drive, social, SEO, accessibility, rollback, and release. Use when AUTO_BUILDER needs enterprise-grade agent automation, orchestration, scaffolding, workflow control, validation, memory, communication, intelligence, or release governance for websites, lead gen, auto social, business systems, XPS locations, PUC attendee systems, or Strategic Minds licensing.
---

# Qa Validator System

## Purpose
Run enterprise QA validation across source truth, manifests, skills, scaffolds, APIs, routes, Supabase, Drive, social, SEO, accessibility, rollback, and release.
