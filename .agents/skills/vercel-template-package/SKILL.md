---
name: vercel-template-package
description: Create and validate reusable Vercel and Next.js template packages for lead-gen sites, dashboards, portals, estimators, social systems, and license portals. Use when AUTO_BUILDER needs enterprise-grade agent automation, orchestration, scaffolding, workflow control, validation, memory, communication, intelligence, or release governance for websites, lead gen, auto social, business systems, XPS locations, PUC attendee systems, or Strategic Minds licensing.
---

# Vercel Template Package

## Purpose
Create and validate reusable Vercel and Next.js template packages for lead-gen sites, dashboards, portals, estimators, social systems, and license portals.
