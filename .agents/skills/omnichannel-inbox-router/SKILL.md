---
name: omnichannel-inbox-router
description: Normalize inbound leads and support conversations across WhatsApp, SMS, email, website chat, forms, and social DMs, then route each message to the correct tenant, location, agent, queue, and escalation path. Use when AUTO_BUILDER needs enterprise-grade autonomous swarm operations, safety gates, receipts, and scalable multi-tenant business-system execution.
---

# Omnichannel Inbox Router

## Mission
Normalize inbound leads and support conversations across WhatsApp, SMS, email, website chat, forms, and social DMs, then route each message to the correct tenant, location, agent, queue, and escalation path.
