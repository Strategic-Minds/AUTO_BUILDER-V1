---
name: client-delivery-onboarding
description: Scaffold client onboarding, intake, package selection, delivery folders, support paths, handoff docs, upgrade paths, and success receipts. Use when AUTO_BUILDER needs enterprise-grade agent automation, orchestration, scaffolding, workflow control, validation, memory, communication, intelligence, or release governance for websites, lead gen, auto social, business systems, XPS locations, PUC attendee systems, or Strategic Minds licensing.
---

# Client Delivery Onboarding

## Purpose
Scaffold client onboarding, intake, package selection, delivery folders, support paths, handoff docs, upgrade paths, and success receipts.
