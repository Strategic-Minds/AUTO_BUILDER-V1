...
description: Define retention, archive, deletion, privacy, consent, attribution, copyright, and source quality policies for intelligence and client data. Use when AUTO_BUILDER needs enterprise-grade agent automation, orchestration, scaffolding, workflow control, validation, memory, communication, intelligence, or release governance for websites, lead gen, auto social, business systems, XPS locations, PUC attendee systems, or Strategic Minds licensing.
---

# Data Retention Compliance

## Purpose
Define retention, archive, deletion, privacy, consent, attribution, copyright, and source quality policies for intelligence and client data.
