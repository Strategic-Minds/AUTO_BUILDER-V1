---
name: evals-improvement-loop
description: Design evaluator loops where agents critique, test, improve, and rerun until criteria pass while producing receipts and blocking unsafe release. Use when AUTO_BUILDER needs enterprise-grade agent automation, orchestration, scaffolding, workflow control, validation, memory, communication, intelligence, or release governance for websites, lead gen, auto social, business systems, XPS locations, PUC attendee systems, or Strategic Minds licensing.
---

# Evals Improvement Loop

## Purpose
Design evaluator loops where agents critique, test, improve, and rerun until criteria pass while producing receipts and blocking unsafe release.
