---
name: tenant-entitlement-licensing
description: Govern tenant licensing, seats, entitlements, package access, agent availability, automation limits, billing state, renewal state, and license compliance receipts. Use when AUTO_BUILDER needs enterprise-grade autonomous swarm operations, safety gates, receipts, and scalable multi-tenant business-system execution.
---

# Tenant Entitlement Licensing

## Mission
Govern tenant licensing, seats, entitlements, package access, agent availability, automation limits, billing state, renewal state, and license compliance receipts.
