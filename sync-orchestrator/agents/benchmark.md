# SYNC CONTRACT — BENCHMARK
# AUTO_BUILDER :: sync-orchestrator/agents/benchmark.md
...
## CHANNELS (primary)
See agent_subscriptions WHERE agent_id = 'benchmark'

## SYNC CHECKLIST (run each sync cycle)
- [ ] Read from agent_registry WHERE agent_id = 'benchmark'
