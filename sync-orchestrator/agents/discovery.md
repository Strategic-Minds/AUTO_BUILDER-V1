# SYNC CONTRACT — DISCOVERY
# AUTO_BUILDER :: sync-orchestrator/agents/discovery.md
...
## CHANNELS (primary)
See agent_subscriptions WHERE agent_id = 'discovery'

## SYNC CHECKLIST (run each sync cycle)
- [ ] Read from agent_registry WHERE agent_id = 'discovery'
