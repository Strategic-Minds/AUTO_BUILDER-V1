# SYNC CONTRACT — OUTREACH
# AUTO_BUILDER :: sync-orchestrator/agents/outreach.md
...
## CHANNELS (primary)
See agent_subscriptions WHERE agent_id = 'outreach'

## SYNC CHECKLIST (run each sync cycle)
- [ ] Read from agent_registry WHERE agent_id = 'outreach'
