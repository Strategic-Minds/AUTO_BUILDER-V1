# SYNC CONTRACT — INTELLIGENCE
# AUTO_BUILDER :: sync-orchestrator/agents/intelligence.md
...
## CHANNELS (primary)
See agent_subscriptions WHERE agent_id = 'intelligence'

## SYNC CHECKLIST (run each sync cycle)
- [ ] Read from agent_registry WHERE agent_id = 'intelligence'
